          ...
          {cards.map((card, index) => (
            <div key={index} className="keen-slider__slide number-slide1">
              <div className="min-w-[300px] bg-white h-[450px] shadow-xl rounded">
                <img src={card.imageUrl} alt={card.heading} className="w-full h-60 object-fill rounded mb-4 static" />
                ...
                <h3 className="text-xl font-bold px-4">{card.heading}</h3>
                <h3 className='text-left pl-4 pb-1'>{card.din}</h3>
                <p className="text-gray-500 text-left tracking-tighter line-clamp-2 text-wrap leading-normal px-4">{card.subheading}</p>
